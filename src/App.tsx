  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
       ...
       {/* Warning Alert */}
       <div
         className="mb-6 bg-amber-100 dark:bg-amber-900/20 border-t-4 border-amber-500 dark:border-amber-400 rounded-b text-foreground dark:text-amber-200 px-4 py-3 shadow-md"
         role="alert"
       >
         <div className="flex">
           <div className="py-1">
